package com.enums.other;// enums/PostOffice.java
...
class Mail {
    ...
    public static Mail randomMail() {
        Mail m = new Mail();
        m.generalDelivery =
                EnumsRandomUtils.random(GeneralDelivery.class);
        m.scannability =
                EnumsRandomUtils.random(Scannability.class);
        m.readability =
                EnumsRandomUtils.random(Readability.class);
        m.address = EnumsRandomUtils.random(Address.class);
        m.returnAddress =
                EnumsRandomUtils.random(ReturnAddress.class);
        return m;
    }
